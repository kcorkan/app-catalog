Ext.define('Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings', {
    singleton: true,
    ...
    setCalculationType: function(type){
        ...
        if (Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.calculationTypes[type]){
            Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.selectedCalculationType = type;
        } else {
            Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.selectedCalculationType = 'points';
        }
    },
    /**
    ...
    getPortfolioItemTypeLevel: function(modelName){
        var idx = _.indexOf(Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.getPortfolioItemTypes(), modelName.toLowerCase());
        return idx;
    },
    ...
    getCalculationTypeSettings: function(){
        return Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.calculationTypes[Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.selectedCalculationType] || Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.calculationTypes.points;
    },
    getCalculationTypeDisplayName: function(){
        return Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.getCalculationTypeSettings().displayName || 'Unknown';
    },
    formatCost: function(cost){
        return Ext.util.Format.currency(cost,
            ...
            Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.currencyPrecision,
            Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.currencyEnd);
    },
    getCostPerUnit: function(project_ref){
        return Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.projectCostPerUnit[project_ref] || Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.normalizedCostPerUnit;
    },

    isProjectUsingNormalizedCost: function(project_ref){
        if (Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.projectCostPerUnit[project_ref]){
            return false;
        }
        return true;
    },
    ...
    getTreeFetch: function(fetch){
       ...
       return Ext.Array.merge(fetch, Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.getStoryFetch(),
                                Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.getPortfolioItemFetch(),
                                (Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.getCalculationTypeSettings().requiredTaskFetch || []));
    ...
    getStoryFetch: function(fetch){
        ...
        return Ext.Array.merge(fetch, Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.requiredFetch,
                        Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.getCalculationTypeSettings().requiredStoryFetch);
    ...
    getPortfolioItemFetch: function(fetch){
        ...
        return Ext.Array.merge(Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.requiredFetch,
            Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings._getPreliminaryBudgetFields(),
            Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.requiredPortfolioItemFetch);

    },
    _getPreliminaryBudgetFields: function(){
        var preliminaryBudgetFields = [Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.preliminaryBudgetField];
        if (Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.preliminaryBudgetField === "PreliminaryEstimate"){
    ...
    getFields: function(config) {
        ...
        var currency_store = Ext.create('Rally.data.custom.Store', {
            data: Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.currencyData
        });
        var labelWidth = 100;

        var cost_items = [];
        _.each(Rally.apps.portfolioitemcosttracking.PortfolioItemCostTrackingSettings.calculationTypes, function(obj, key){
            cost_items.push({
